...
- I found a new hobby that creating a song with AI. Click the link to listen to my songs [https://sp-song.netlify.app/](https://sp-song.netlify.app/)<br />keydown - 'p' to pause/start, 'arrow left/right' to skip, 'arrow up/down' to volume up/down, and 'm' to mute
